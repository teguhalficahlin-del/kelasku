...
async function init() {
  ...
  try {
    ...
    // JANGAN signOut di sini. Kegagalan memuat profil hampir selalu masalah
    // jaringan sesaat — sinyal hilang saat aplikasi dibuka, atau server balas
    // 5xx. Menghapus sesi karenanya memaksa login ulang padahal sesinya sah,
    // dan itulah yang selama ini terasa seperti "logout sendiri".
    console.error('[siswa] gagal memuat profil:', err);
